...
- **Zero-Config, Pre-Validated Data** — Works out of the box with a pre-validated benchmark snapshot; warns you when data is older than 6 hours so you can refresh.
...
│   ├── models.ts                # Model definitions (ecoclaw/best|balance|eco)
...
├── src/data/
│   ├── cache.ts                 # Benchmark data loader (snapshot-based)
│   └── snapshot.json            # Pre-validated benchmark snapshot
├── scripts/
